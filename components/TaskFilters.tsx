...
export default function TaskFilters({
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <select
        className="px-4 py-2.5 border border-gray-300 text-gray-900 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all cursor-pointer bg-white sm:w-auto appearance-none"
        style={{
